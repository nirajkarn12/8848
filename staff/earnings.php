		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">NZ$ <?php echo number_format($totals['pending'], 2); ?></span>
				</div>
			</div>
		</div>
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">NZ$ <?php echo number_format($totals['approved'], 2); ?></span>
				</div>
			</div>
		</div>
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">NZ$ <?php echo number_format($totals['paid'], 2); ?></span>
				</div>
			</div>
		</div>
	</div>
						...
						<tbody>
							...
							foreach ($jobs as $job) {
								...
								<tr>
									...
									<td><strong>NZ$ <?php echo number_format((float)$job['commission_amount'], 2); ?></strong></td>
