...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product-add.php" class="btn btn-primary btn-sm">Add Service</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>NZ$<?php echo $row['p_old_price']; ?></td>
									<td>NZ$<?php echo $row['p_current_price']; ?></td>
									<td>
									...
									<td><?php echo $row['tcat_name']; ?> → <?php echo $row['mcat_name']; ?></td>
									<td>										
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! This service will also be removed from related booking records.</p>
            </div>
